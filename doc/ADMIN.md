...
* Install the [Redirect App](https://apps.yunohost.org/app/redirect) (`redirect_ynh`) at the root of this domain and make it point in reverse_proxy` mode to `http://127.0.0.1:__PORT_API__ `
